      ...
      <div class="d-flex flex-column flex-root">
         ...
         <div class="d-flex flex-row flex-column-fluid page">
                     ...
                     <ul class="menu-nav">
                        ...
                        <li
                          ...
                          <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu" style="display: none; overflow: hidden;" kt-hidden-height="240">
										<i class="menu-arrow"></i>
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="/metronic/demo1/rtl/layout/general/no-header-menu.html" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">أنشاء فاتورة مباشرة</span>
												</a>
											</li>
                                 ...
                                 <li class="menu-item" aria-haspopup="true">
												<a href="/metronic/demo1/rtl/layout/general/no-header-menu.html" class="menu-link">
													...
													<span class="menu-text">الفواتير المباشرة</span>
												</a>
											</li>
                                   ...
                                   <li class="menu-item" aria-haspopup="true">
												<a href="/metronic/demo1/rtl/layout/general/no-header-menu.html" class="menu-link">
													...
													<span class="menu-text">فواتيرالصيانة </span>
												</a>
											</li>
										</ul>
									</div>
            ...
            <div
               ...
               id="kt_wrapper" style="min-height: 100vh;"
               >
               <!--begin::Header-->
